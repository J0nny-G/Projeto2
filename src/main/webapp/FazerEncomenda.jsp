...
<div class="form-container">
  <h1>Formulário</h1>
  <form action="FazerEncomenda" method="POST">

    <label for="nome">Id Fornecedor:</label>
    <input type="text" id="nome" name="idfornecedor">

    <label for="email">Id Administrador:</label>
    <input type="text" id="email" name="idadmin">
