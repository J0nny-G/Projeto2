...
<%@ page import="entity.PedidoCompra" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>

<%
  List<PedidoCompra> listaDeEncomendas = new ArrayList<>();
  ...
  try {
    ...
    while (resultSet.next()) {
      String id_pedido_compra = resultSet.getString("ID_PEDIDO_COMPRA");
      String nome_fornecedor = resultSet.getString("ID_FORNECEDOR");
      String status_pedido_compra = resultSet.getString("STATUS_PEDIDO_COMPRA");
      String data_pedido_compra = resultSet.getString("DATA_PEDIDO_COMPRA");

      PedidoCompra pedidoCompra = new PedidoCompra();
      pedidoCompra.setIdPedidoCompra(Integer.parseInt(id_pedido_compra));
      pedidoCompra.setIdFornecedor(Integer.parseInt(nome_fornecedor));
      pedidoCompra.setStatusPedidoCompra(status_pedido_compra);
      pedidoCompra.setDataPedidoCompra(Date.valueOf(data_pedido_compra));


      listaDeEncomendas.add(pedidoCompra);
    }
...
<div class="table-container">
  ...
  <table>
    ...
    <tbody>
    <% for (PedidoCompra pedidoCompra : listaDeEncomendas) { %>
    <tr>
      <td><%= pedidoCompra.getIdPedidoCompra() %></td>
      <td><%= pedidoCompra.getIdFornecedor() %></td>
      <td><%= pedidoCompra.getStatusPedidoCompra() %></td>
      <td><%= pedidoCompra.getDataPedidoCompra() %></td>
    </tr>
    <% } %>
    </tbody>
  </table>
